...
public abstract class ATransitionRoot extends ARootShape {

  private static final long serialVersionUID = 2081801530762140695L;
   ...
   */
  public ATransitionRoot(TransitionType tt) {
    super(40, 5, "");
    setup(tt);
  }


  public ATransitionRoot(int width, int height, TransitionType tt) {
    super(width, height, "");
    setup(tt);
  }
