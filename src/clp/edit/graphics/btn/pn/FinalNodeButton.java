...
public class FinalNodeButton extends APetriNetsButton {

  private static final long serialVersionUID = 4125322662159272184L;

  public FinalNodeButton(PetriNetsButtonsPanel panel, String tooltip, ShapeButton b) {
    super(b);
  ...
  public void paintComponent(Graphics g) {
    ...
    g.fillRect(5, 10, 20, 4);
    g.drawLine(15, 2, 15, 10);
  }
