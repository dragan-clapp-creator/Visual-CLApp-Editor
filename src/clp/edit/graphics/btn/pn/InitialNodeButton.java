...
public class InitialNodeButton extends APetriNetsButton {

  private static final long serialVersionUID = 1123826984874962971L;

  public InitialNodeButton(PetriNetsButtonsPanel panel, String tooltip, ShapeButton b) {
    super(b);
