...
public class FinalNodeButton extends AGrafcetButton {

  private static final long serialVersionUID = -8892165461206959097L;
   ...
   * @param b
   */
  public FinalNodeButton(GrafcetButtonsPanel panel, String tooltip, ShapeButton b) {
    super(b);
