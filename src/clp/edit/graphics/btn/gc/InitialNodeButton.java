...
public class InitialNodeButton extends AGrafcetButton {

  private static final long serialVersionUID = -7164283001620151996L;
   ...
   * @param container
   */
  public InitialNodeButton(GrafcetButtonsPanel panel, String tooltip, ShapeButton b) {
    super(b);
