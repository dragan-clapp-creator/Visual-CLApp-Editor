...
public class TransitionNodeButton extends AGrafcetButton {

  private static final long serialVersionUID = -1639964576829223531L;
   ...
   * @param b
   */
  public TransitionNodeButton(GrafcetButtonsPanel panel, String tooltip, ShapeButton b) {
    super(b);
