...
public class ForkDialog extends ADialog implements ActionListener {

  private static final long serialVersionUID = -5185977863757606895L;

  private AForkShape shape;

  private JTextField wfield;

  public ForkDialog(AForkShape shape) {
